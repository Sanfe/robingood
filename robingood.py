...
# IDs de los canales
CHANNEL_ID_1 = -1 # Canal 1 (Movies)
CHANNEL_ID_2 = -1 # Canal 2 (Series)
CONTROL_CHANNEL_ID = -1 # Canal de control

# Directorios para guardar y extraer archivos
SAVE_DIR_1 = '/run/media/mmcblk0p1/Movies/.temp/'
SAVE_DIR_2 = '/run/media/mmcblk0p1/Series/.temp/'
EXTRACT_DIR_1 = '/run/media/mmcblk0p1/Movies/'
EXTRACT_DIR_2 = '/run/media/mmcblk0p1/Series/'
